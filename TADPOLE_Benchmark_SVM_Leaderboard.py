...
# Select features
cog_tests_attributes = ["CDRSB", 'EcogPtTotal','MOCA', "MMSE", "RAVLT_immediate"]
mri_measures = ['Hippocampus', 'WholeBrain', 'Entorhinal', 'MidTemp', 'Fusiform','ICV_bl']
...
Dtadpole = Dtadpole[['RID'] +values + mri_measures + pet_measures + cog_tests_attributes + risk_factors].copy()
...
Dtrain = D.drop(['RID', 'Diagnosis', 'Ventricles', 'Hippocampus', 'WholeBrain', 'Entorhinal', 'MidTemp', 'Fusiform'], axis=1).copy()
